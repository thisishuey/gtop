...
const memLine = grid.set(2, 0, 2.125, 1.99, contrib.line, {
  showNthLabel: 5,
  maxY: 100,
...
const procTable = grid.set(2, 2, 4, 1.0125, contrib.table, {
  keys: true,
  vi: true,
  label: "Processes",
  columnSpacing: 1,
...
const netSpark = grid.set(4, 0, 1, 0.97, contrib.sparkline, {
...
const diskDonut = grid.set(5, 0, 1, 0.97, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: "black",
